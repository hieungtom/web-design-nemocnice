...
confirmButton.addEventListener("click", (e) => {
    ...
    const dayElement = Array.from(dayElements)
    .find(day => day.querySelector('p')?.textContent === selectedDate);
    ...
    if(dayElement){
        ...
        if(success){
            renderCalendar();
            console.log(`Rezervace proběhla na termín: ${date}, ${selectedTime}, ${department}`);
